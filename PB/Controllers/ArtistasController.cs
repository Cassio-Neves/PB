...
namespace PB.Controllers
{
    public class ArtistasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Genero,Descricao,PhotoUrl")] Artista artista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Genero,Descricao,PhotoUrl")] Artista artista)
        {
            if (id != artista.Id)
            {
                return NotFound();
